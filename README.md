...
* Displays histograms generated by python script which runs a query and profuces the grpahs using query result.
* Constructs two histograms:
 1) The histogram of the number of collaborators
   * This histogram represents  the X axis is a number X=1,2,3 and the Y axis represents the number of authors with X collaborators
 2) The histogram of the number of publications.
